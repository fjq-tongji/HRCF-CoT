...
if __name__ == '__main__':
    ...
    parser.add_argument('--stage-1', default='./Each_stage_texts_CODA/CODA_text_critic_ovis2_calculate_inference_time_ovis.json')
    ...
    with open('./Each_stage_texts_CODA/CODA_text_critic_ovis2_calculate_inference_time_SG_generation.json', 'w', encoding='utf-8') as f:

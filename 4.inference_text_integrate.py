...
from transformers import AutoModel, AutoTokenizer, AutoModelForCausalLM, AutoProcessor, AutoModelForZeroShotObjectDetection, InstructBlipProcessor, InstructBlipForConditionalGeneration, Qwen2VLForConditionalGeneration
...
if __name__ == '__main__':
    ...
    parser.add_argument('--stage-1', default='./Each_stage_texts_CODA/LLaVA-1.5-7B_results----Ablation_studies/Ablation4_65/CODA_all_three_branch_infor_final_integrate_465_1.json')
    ...
    #     "/share/home/tj21012/fjq/MLLMS/0_MLLM_weights/Qwen2-VL-7B-Instruct-weights", torch_dtype="auto",
    #     device_map="auto"
    # )
    # processor_qwen2_vl = AutoProcessor.from_pretrained(
    #     "/share/home/tj21012/fjq/MLLMS/0_MLLM_weights/Qwen2-VL-7B-Instruct-weights")
    ...
    pipeline_llama_3_8B = transformers.pipeline(
        "text-generation", model='/share/home/u21012/fjq/LLAMA3/Meta-Llama-3-8B-Instruct',
    ...
    with open('./Each_stage_texts_CODA/LLaVA-1.5-7B_results----Ablation_studies/Ablation4_65/CODA_llama_text_integrate_465_1.json', 'w', encoding='utf-8') as f:

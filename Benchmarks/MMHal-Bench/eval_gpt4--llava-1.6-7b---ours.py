...
if __name__ == '__main__':
    ...
    parser.add_argument('--response', type=str, default='responses/Open_images_llava_1.6_7b_MMHal_Bench_answers_ours.json', help='response file containing images, questions, and model responses')
    parser.add_argument('--evaluation', type=str, default='./gpt4_evaluation_results/Open_images_llava_1.6_7b_results_ours.json', help='GPT-4 evaluation results to be saved')
    args = parser.parse_args()

    openai.api_key = 'sk-proj-OiklAoCznCELNxEydFOmT3BlbkFJo5OTkrC0QCrCKCpIlOE1'

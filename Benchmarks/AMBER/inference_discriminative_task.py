...
def get_args():
    ...
    parser.add_argument("--inference_data", default='/share/home/MLLMS/LLaVA-v1.5-13b/AMBER_1004/AMBER_llava_1.5_13b_initial_discriminative_task.json', type=str)
    ...
    parser.add_argument('--evaluation_type', default='d', choices=['a', 'g', 'd', 'de', 'da', 'dr'], help='a: all tasks and dimensions    g: generative task    d: descriminative task    de, da, dr: existence, attribute, relation')

...
# 保存输出结果的文档
output_file = './GPT4-scores/GPT_CODA_dafen_llava_1.6_7b_accuracy.json'               ########### 8个文件的答案存到一个json里面
...
Please rate the responses of the assistants on a scale of 1 to 5, where a higher score indicates better performance,
according to the following criteria:
Accuracy: whether the response is accurate with respect to the image content. You should pay extra attention to the hallucination, 
which refers to the part of descriptions that are inconsistent with the image content, such as claiming the existence of something 
not present in the image. An answer with fewer hallucinations should be given higher scores. 

...
#######################################################################################################################################
PROMPT_kimi_attribute = '''
The following paragraph describes a traffic scene. Please analyze this description and find out phrases about attribute information?
Only return phrases of attribute information, separated by a comma between two elements.
...
def Kimi_extract_entity(texts):
    texts_extract_entity_prompts_ = PROMPT_kimi_attribute.format(Texts=texts)

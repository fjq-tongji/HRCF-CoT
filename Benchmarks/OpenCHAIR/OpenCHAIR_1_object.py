...
#######################################################################################################################################
PROMPT_kimi_object = '''
The following paragraph describes a traffic scene. Please analyze this description, what traffic participants exist in the scene?
Only return traffic element without attribute words, and separate any two elements with a comma.
Avoid abstract words, proper nouns, sky-related words, color-related words, weather-related words, and tree-related words.
Please strictly following the output format: obj1, obj2
{Texts}
'''
...
def Kimi_extract_entity(texts):
    texts_extract_entity_prompts_ = PROMPT_kimi_object.format(Texts=texts)
